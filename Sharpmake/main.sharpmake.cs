...
class SkelEngine : Project
{
    public SkelEngine()
    {
        ...
        SourceRootPath = Path.Combine("[project.SharpmakeCsPath]", @"..\SkelCore");
    ...
    [Generate]
    class SkelEngineSolution : Solution
    {
    ...
    public static void SharpmakeMain(Arguments sharpmakeArgs)
    {
        ...
        // BasicsSolution.
        sharpmakeArgs.Generate<SkelEngineSolution>();
    }
}